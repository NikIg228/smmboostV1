  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mt-12">
        <div className="bg-gradient-to-r from-pink-500/10 to-purple-600/10 rounded-xl p-8 border border-purple-500/20">
          ...
          <button className="px-8 py-3 bg-gradient-to-r from-pink-500 to-purple-600 text-white font-semibold rounded-lg hover:from-pink-600 hover:to-purple-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-pink-500/25">
            Выбрать услугу
          </button>
        </div>
      </div>
